...
/**
 * DistanceMatrixHash stores distances between pairs of points of type T
...
public interface DistanceMatrix<T> {
  ...
  /**
   * adds new distance to DistanceMatrixHash associated with
  ...
  /**
   * removes distance from DistanceMatrixHash which corresponding to
   * (point1, point2) unordered pair
   *
  ...
  /**
   * @return true if there is such distance associated with (point1, point2) unordered pair, false
   * otherwise
   */
  boolean containsDistance(T point1, T point2);

  /**
   * @return distance associated with (point1, point2) unordered pair null otherwise
   */
  Double getDistance(T point1, T point2);

  /**
   * removes all values from DistanceMatrixHash which coordinates include point
   *
