...
public class DistanceMatrixTests {
  ...
  public void testGetPairWithMinDistance() {
    ...
    Assert
        .assertNotEquals(new UnorderedPairHash(pt1, pt2), distanceMatrix.getPairWithMinDistance());
  ...
  public void testGetPairWithMaxDistance() {
    ...
    distanceMatrix.deleteDistance(pt1, pt2);
    Assert
        .assertNotEquals(new UnorderedPairHash(pt1, pt2), distanceMatrix.getPairWithMaxDistance());
